...
/// </summary>
public sealed class ConfirmationSampleOptions
{
    /// <summary>Configuration section of these settings.</summary>
    public const string SectionName = "ConfirmationSample";
    ...
    /// <summary>Action type declared in the MessageTemplates of that client entry.</summary>
...
/// </summary>
public sealed class VeriqaConfirmationClient(HttpClient http, ConfirmationSampleOptions options, VeriqaAccessTokenCache tokens)
{
